...
public class StoreService {
    ...
    public Long saveStore(List<MultipartFile> multipartFiles, StoreRequestDto storeRequestDto)
    {
        ...
        Store store = Store.createStore(storeRequestDto.getName(), storeRequestDto.getCall(), storeRequestDto.getComment(),storeRequestDto.getAddress(), storeRequestDto.getTime(), storeRequestDto.isKids(), storeRequestDto.getCategoryIds(), storeRequestDto.getConvenienceIds(), result, fileNameList);
